...
```
S-> aB-> bB-> bB-> bB-> bB-> cL-> bStop
Cuvant generat: abbbbcb
Este valid conform Automatului? DA
----------------------------------------------
...
S-> aB-> bB-> cL-> cL-> bStop
Cuvant generat: abccb
Este valid conform Automatului? DA
----------------------------------------------

S-> aB-> cL-> aS-> aB-> bB-> bB-> cL-> cL-> bStop
Cuvant generat: acaabbccb
Este valid conform Automatului? DA
----------------------------------------------

S-> aB-> bB-> cL-> aS-> aB-> cL-> cL-> bStop
Cuvant generat: abcaaccb
Este valid conform Automatului? DA
----------------------------------------------

Test cuvant invalid manual ('aaabbb'): false
```
